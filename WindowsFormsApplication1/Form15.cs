...
namespace WindowsFormsApplication1
{
    public partial class Form15 : Form
    {
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            //Call the Form 22's drawCircle method to draw the circular marker over the technology and innovation part of the map
            f22.drawCircle();
            //Set the directions String of Form 22
            f22.directions = "Go through the entrance, then turn left and go through the Air and Space gallery. Go through the Transport gallery and then go right";
        }
