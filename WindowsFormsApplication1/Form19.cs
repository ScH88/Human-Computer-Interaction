...
namespace WindowsFormsApplication1
{
    public partial class Form19 : Form
    {
        ...
        private void label2_Click(object sender, EventArgs e)
        {
            ...
            f22.markerHeight = 80;
            //Call the Form 22's drawCircle method to draw the circular marker over the Roman history exhibit part of the map
            f22.drawCircle();
            //Set the directions String of Form 22
            f22.directions = f22.directions = "Go to the History exhibit just across the main hall. It should be across the exhibit between Ancient Egyptians and Wartime Britain";
        }
